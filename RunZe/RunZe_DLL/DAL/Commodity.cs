...
namespace Maticsoft.DAL
{
	...
	public partial class Commodity
	{
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select CommodityID,CommodityFatherID,CommoditySonID,CommodityName,CommodityPrice,MarketPrice,VIPPrice,Stock,BuyScore,CommodityImage,CommodityType,CommoditySaled,Introduce,CommodityTime,Recommend,CommodityState");
            strSql.Append(" FROM Commodity ");
            if (strWhere.Trim() != "")
            {
                strSql.Append(" where " + strWhere + " order by CommodityTime desc ");
            }
            return DbHelperSQL.Query(strSql.ToString());
        }
        ...
        public DataSet GetList3(string strWhere)
        {
            ...
            strSql.Append(" FROM Commodity a,CommodityFather b,CommoditySon c ");
            if (strWhere.Trim() != "")
            {
                strSql.Append(" where a.CommodityFatherID = b.CommodityFatherID and a.CommoditySonID=c.CommoditySonID and" + strWhere + " order by CommodityTime desc ");
            }
            if (strWhere.Trim() == "")
            {
                strSql.Append(" where a.CommodityFatherID = b.CommodityFatherID and a.CommoditySonID=c.CommoditySonID order by CommodityTime desc ");
            }
            return DbHelperSQL.Query(strSql.ToString());
        }
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select a.CommodityID,b.AppriseID,CommodityFatherID,CommoditySonID,CommodityName,CommodityPrice,MarketPrice,VIPPrice,Stock,BuyScore,CommodityImage,CommodityType,CommoditySaled,Introduce,CommodityTime,Recommend,CommodityState,Score,ScoreTimes ");
            strSql.Append(" FROM Commodity a,Appraise b ");
            if (strWhere.Trim() != "")
            {
                strSql.Append(" where " + strWhere);
            }
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select count(1) FROM Commodity a,Appraise b ");
            if (strWhere.Trim() != "")
            {
                strSql.Append(" where " + strWhere);
            }
