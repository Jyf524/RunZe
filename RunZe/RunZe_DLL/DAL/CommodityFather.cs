...
namespace Maticsoft.DAL
{
	...
	public partial class CommodityFather
	{
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select distinct a.CommodityFatherID,CommodityFatherName ");
            strSql.Append(" FROM CommodityFather a,CommoditySon b ");
            if (strWhere.Trim() != "")
            {
                strSql.Append(" where  a.CommodityFatherID = b.CommodityFatherID " + strWhere);
            }
            if (strWhere.Trim() == "")
            {
                strSql.Append(" where  a.CommodityFatherID = b.CommodityFatherID " + strWhere);
