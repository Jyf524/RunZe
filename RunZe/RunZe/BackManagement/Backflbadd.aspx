<%@ Page Title="" Language="C#" MasterPageFile="~/BackManagement/BackManagement.Master" AutoEventWireup="true" CodeBehind="Backflbadd.aspx.cs" Inherits="RunZe.BackManagement.Backflbadd" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
 ...
 添加父类别:<telerik:RadTextBox ID="RadTextBox1" Runat="server" LabelWidth="64px" Resize="None" Width="160px">
     </telerik:RadTextBox>
&nbsp;</div>
