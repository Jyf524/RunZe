<%@ Page Title="" Language="C#" MasterPageFile="~/BackManagement/BackManagement.Master" AutoEventWireup="true" CodeBehind="Backzlbadd.aspx.cs" Inherits="RunZe.BackManagement.Backzlbadd" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
 ...
 子类别添加:<telerik:RadTextBox ID="RadTextBox1" Runat="server" LabelWidth="64px" Resize="None" Width="160px">
     </telerik:RadTextBox>
&nbsp;</div>
