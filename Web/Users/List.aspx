...
<!--Title -->
		...
		<asp:BoundField DataField="UserPassword" HeaderText="UserPassword" SortExpression="UserPassword" ItemStyle-HorizontalAlign="Center"  /> 
		<asp:BoundField DataField="UserRealName" HeaderText="UserRealName" SortExpression="UserRealName" ItemStyle-HorizontalAlign="Center"  /> 
		<asp:BoundField DataField="UserSex" HeaderText="UserSex" SortExpression="UserSex" ItemStyle-HorizontalAlign="Center"  /> 
		<asp:BoundField DataField="UserEmail" HeaderText="UserEmail" SortExpression="UserEmail" ItemStyle-HorizontalAlign="Center"  /> 
		<asp:BoundField DataField="UserGrade" HeaderText="UserGrade" SortExpression="UserGrade" ItemStyle-HorizontalAlign="Center"  /> 
		<asp:BoundField DataField="UserScore" HeaderText="UserScore" SortExpression="UserScore" ItemStyle-HorizontalAlign="Center"  /> 
		...
		<asp:BoundField DataField="Address1" HeaderText="Address1" SortExpression="Address1" ItemStyle-HorizontalAlign="Center"  /> 
		<asp:BoundField DataField="UserIdentity" HeaderText="UserIdentity" SortExpression="UserIdentity" ItemStyle-HorizontalAlign="Center"  /> 
		<asp:BoundField DataField="RegistTime" HeaderText="RegistTime" SortExpression="RegistTime" ItemStyle-HorizontalAlign="Center"  /> 
